...
# coding: utf-8
#
##Script to print Z-linked genes
#USAGE: python Z-linked_ONLY.py /ABS/PATH/TO/DIR/Infile_OK.txt
#
#1) PREPARE WORKSPACE
import sys
import os
...
with open(inputFile, 'r') as inFile, open((species + "_Z-linked_ONLY.txt"), 'w') as outFile:
	for line in inFile:
